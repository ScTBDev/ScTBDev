...
{CLASS_LIST}
							...
							<tr>
								<td class="edituser_primcol">Uploaded</td>
								<td class="edituser_seccol">
									<input type="text" name="uploaded" size="50" class="g_s_input" style="margin-bottom: 3px;" value="{UPLOADED}" /><br />
									+ <input type="text" name="upl_add" size="10" class="g_s_input" value="0" />
									<select name="upl_add_size" class="g_selectlist">
										<option value="T">TB</option>
										<option value="G" selected="selected">GB</option>
										<option value="M">MB</option>
									</select>
									- <input type="text" name="upl_rem" size="10" class="g_s_input" value="0" />
									<select name="upl_rem_size" class="g_selectlist">
										<option value="T">TB</option>
										<option value="G" selected="selected">GB</option>
										<option value="M">MB</option>
									</select>
								</td>
								<td class="edituser_primcol">Downloaded</td>
								<td class="edituser_seccol">
									<input type="text" name="downloaded" size="50" class="g_s_input" style="margin-bottom: 3px;" value="{DOWNLOADED}" /><br />
									+ <input type="text" name="dnl_add" size="10" class="g_s_input" value="0" />
									<select name="dnl_add_size" class="g_selectlist">
										<option value="T">TB</option>
										<option value="G" selected="selected">GB</option>
										<option value="M">MB</option>
									</select>
									- <input type="text" name="dnl_rem" size="10" class="g_s_input" value="0" />
									<select name="dnl_rem_size" class="g_selectlist">
										<option value="T">TB</option>
										<option value="G" selected="selected">GB</option>
										<option value="M">MB</option>
									</select>
							...
							<tr>
								<td class="edituser_primcol">Appear as</td>
								<td class="edituser_seccol">
									<input type="radio" name="anon" value="1"{ANON_ON} /> <i>Anonymous</i>
									<input type="radio" name="anon" value="0"{ANON_OFF} /> {USERNAME}
								</td>
								<td class="edituser_primcol">Hide Stats</td>
								<td class="edituser_seccol">
									<input type="radio" name="hide_stats" value="1"{HIDE_ON} /> Yes
									<input type="radio" name="hide_stats" value="0"{HIDE_OFF} /> No
								</td>
							</tr>
							<tr>
								<td class="edituser_primcol">Status</td>
								<td class="edituser_seccol">
									<input type="radio" name="status" value="1"{STATUS_ON} /> Confirmed
									<input type="radio" name="status" value="0"{STATUS_OFF} /> Pending
								</td>
								<td class="edituser_primcol">Donor</td>
								<td class="edituser_seccol">
									<input type="radio" name="donor" value="1"{DONOR_ON} /> Yes
									<input type="radio" name="donor" value="0"{DONOR_OFF} /> No
									<span style="position: relative; left: 50px">
										Disable Invite Buying <input type="checkbox" name="disable_invites" value="1"{DISABLE_INVITES} />
									</span>
								</td>
							</tr>
							<tr>
								<td class="edituser_primcol">IRC Channel Access</td>
								<td class="edituser_seccol" colspan="3">
									<table class="edituser_irctable">
										<tr>
{IRC_LIST}
										</tr>
									</table>
							...
							<tr>
								...
								<td class="edituser_seccol" colspan="3">
									...
									<textarea class="g_s_input" name="modcomment" cols="97" rows="7">{MOD_COMMENTS}</textarea>
								</td>
							</tr>
							<tr>
